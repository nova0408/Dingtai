...
class AprilTagMarkerGeneratorWindow(QMainWindow):
    """单个 AprilTag 标记块批量生成窗口。"""
    ...
    def _setup_window(self) -> None:
        self.setWindowTitle("AprilTag Marker Generator")
        self.resize(820, 700)
    ...
    def _build_config_group(self) -> QGroupBox:
        ...
        self._dictionary_name_combo.setCurrentText("DICT_APRILTAG_36H11")
    ...
    def _dictionary_id(dictionary_name: str) -> int:
        return DICTIONARY_NAME_TO_ID[dictionary_name]
    ...
    def _build_output_filename(
        ...
        dictionary_slug = dictionary_name.lower().replace("dict_apriltag_", "")
        return f"apriltag_{dictionary_slug}_id{marker_id:02d}_{size_px}px{outline_suffix}.png"
...
def main() -> int:
    ...
    window = AprilTagMarkerGeneratorWindow()
    window.show()
    return app.exec()
