...
from . import servo
from . import utility
__all__: list[str] = ['ArRobot', 'AvoidSingularityMethod', 'BaseCobot', 'BaseRobot', 'CAN', 'CANFD', 'CANFD_ACCELERATED', 'CANFormat', 'CANFrame', 'CANType', 'CartesianPosition', 'CartesianPositionOffset', 'CartesianPositionOffsetType', 'Cobot_5', 'Cobot_6', 'Cobot_7', 'CoordinateType', 'DragParameterSpace', 'DragParameterType', 'EXTENDED', 'Event', 'EventInfoKey', 'Finishable', 'Frame', 'FrameCalibrationResult', 'FrameType', 'Idle', 'IndustrialRobot_3', 'IndustrialRobot_4', 'IndustrialRobot_6', 'Info', 'JogOptSpace', 'JointPosition', 'KeyPadState', 'Load', 'LogInfo', 'LogInfoLevel', 'MotionControlMode', 'MoveAbsJCommand', 'MoveCCommand', 'MoveCFCommand', 'MoveCFCommandRotType', 'MoveJCommand', 'MoveLCommand', 'MoveSPCommand', 'MoveWaitCommand', 'NrtCommand', 'NrtCommandMode', 'NrtRLTask', 'OperateMode', 'OperationState', 'PCB3Robot', 'PCB4Robot', 'PowerState', 'PyErrorCode', 'PyForceControl5', 'PyForceControl6', 'PyForceControl7', 'PyString', 'PyTypeBool', 'PyTypeDouble', 'PyTypeFloat', 'PyTypeInt', 'PyTypeUInt64', 'PyTypeUInt8', 'PyTypeVectorArrayDouble2', 'PyTypeVectorBool', 'PyTypeVectorDouble', 'PyTypeVectorFloat', 'PyTypeVectorInt', 'PyTypeVectorString', 'RLProjectInfo', 'Robot_T_Collaborative_5', 'Robot_T_Collaborative_6', 'Robot_T_Collaborative_7', 'Robot_T_Industrial_3', 'Robot_T_Industrial_4', 'Robot_T_Industrial_6', 'RtCommandMode', 'RtControllerMode', 'RtSupportedFields', 'STANDARD', 'StandardRobot', 'StopLevel', 'Toolset', 'Torque', 'WorkToolInfo', 'WorkType', 'automatic', 'base', 'baseFrame', 'baseParallelMode', 'cartesianImpedance', 'cartesianPosition', 'cartesianSpace', 'collaborative', 'constPose', 'createErrorCode', 'demo', 'drag', 'dynamicIdentify', 'endInRef', 'error', 'estop', 'fixedAxis', 'flange', 'flangeInBase', 'freely', 'frictionIdentify', 'gstop', 'idle', 'industrial', 'info', 'jog', 'jogging', 'jointImpedance', 'jointPosition', 'jointSpace', 'jointWay', 'loadIdentify', 'lockAxis4', 'logReporter', 'manual', 'message', 'model', 'motioncontrolRT', 'moveExecution', 'moving', 'none', 'off', 'offs', 'on', 'path', 'planner', 'rail', 'relTool', 'reserve', 'rlExecution', 'rlProgram', 'rotAxis', 'rotationOnly', 'rtControlling', 'safety', 'servo', 'singularityAvoidMode', 'stop0', 'stop1', 'stop2', 'suppleStop', 'supply12v', 'supply24v', 'tool', 'toolFrame', 'torque', 'translationOnly', 'unknown', 'utility', 'warning', 'wobj', 'wobjFrame', 'world', 'wrist', 'xMateCr5Robot', 'xMateErProRobot', 'xMateRobot', 'xPanelOptVout']
class ArRobot(Cobot_7):
    """
    AR机型
    """
    @typing.overload
...
class BaseCobot(BaseRobot):
    def CANReceiveData(self, timeout_ms: int, data_type: str, recv_frame: CANFrame, ec: dict) -> None:
        """
        通过xPanel末端直接接收CAN协议裸数据
        
        Args:
             opt (int): 接收超时时间, 0-65535
             opt (string): 支持的数据类型, int16、uint16、uint8
             opt (list[CANFrame]):发送CAN数据的结构体
             ec (dict): 错误码
        """
    def CANSendData(self, data_type: str, send_frames: list[CANFrame], ec: dict) -> None:
        """
        通过xPanel末端直接传输CAN协议裸数据
...
class BaseRobot:
    ...
    def getStateData(self, fieldName: str, data: PyTypeVectorBool) -> int:
        ...
    def importFile(self, file_path: str, dest: str, overwrite: bool, ec: dict) -> None:
        """
        导入本地文件到控制器。阻塞等到导入完成或失败
        
        Args:
             src_file_path (str): 本地文件路径。文件大小在10M以内
             dest (str): 目标路径
                  1. 传输单个RL工程 .mod文件: project/[工程名]/[任务名]</[mod文件名]>
                  2. 传输RL工程.json/.xml/.sys格式的配置文件: project/[工程名]</[文件名]>。
                       * 注意: 配置文件名称不可更改，比如任务文件名必须是"task.xml"
             overwrite (bool): 覆盖同名文件: true - 覆盖 | false - 自动重命名。仅.mod文件支持自动重命名
             ec (dict): 错误码, 本地文件不存在; 文件格式错误; 传输失败; 目标路径不符合要求等
        
        Returns:
             导入成功后文件名
        """
    def importProject(self, file_path: str, overwrite: bool, ec: dict) -> None:
        """
    ...
    def removeProject(self, name: str, ec: dict, remove_all: bool = False) -> None:
        ...
        Args:
             ...
             remove_all (bool): 是否删除所有工程，缺省值是false
             ec (dict): 错误码
        """
    ...
    def setBaseFrame(self, frame: Frame, ec: dict) -> None:
        ...
        Args:
             ...
             ec (dict): 错误码输出。
        """
    def setConnectionHandler(self, handler: typing.Callable[[bool], None]) -> None:
        """
        设置连接断开回调函数
    ...
    def setDefaultConfOpt(self, forced: bool, ec: dict) -> None:
        ...
        Args:
             ...
             ec (dict): 错误码。若操作失败,错误码将被设置为相应的错误信息。
        """
    def setDefaultSpeed(self, speed: float, ec: dict) -> None:
        """
        设定默认运动速度，单位mm/s, 初始值为100
        
        Note:
             该数值表示末端最大线速度,自动计算对应关节速度。
        ...
        Args:
             speed (int): 末端线速度。该接口不对参数进行范围限制。末端线速度的实际有效范围分别是(0, 4000](协作), (0, 7000](工业)。
             ec (dict): 错误码。若操作失败,错误码将被设置为相应的错误信息。
        """
    def setDefaultZone(self, zone: float, ec: dict) -> None:
        """
        设定默认转弯区, 单位:mm。初始值为为0 (fine, 无转弯区)
        
        Note:
             该该数值表示运动最大转弯区半径, 自动计算转弯百分比
             转弯百分比划分4个范围:
             - < 1 : 0 (fine)
             - 1 ~ 20 : 10%
             - 20 ~ 60 : 30%
        ...
        Args:
             zone (float): 转弯区半径大小。该接口不对参数进行范围限制。转弯区半径大小实际有效范围是[0, 200]。
             ec (dict): 错误码。若操作失败,错误码将被设置为相应的错误信息。
        """
    ...
    def setToolInfo(self, tool_info: WorkToolInfo, ec: dict) -> None:
        """
        读设置全局工具信息，或新建/设置RL工程中工具的位姿信息和负载信息
        ...
        Args:
             ...
             ec (dict): 错误码, 全局工具一般不会设置失败。工程中工具可能会设置失败，比如给控制器推送了工程的工具配置文件但是没有重新加载工程，工具配置不一致的情况下会返回错误码
        """
    @typing.overload
...
class CANFormat:
    ...
    Members:
      ...
      EXTENDED : 扩展帧
    """
    EXTENDED: typing.ClassVar[CANFormat]  # value = <CANFormat.EXTENDED: 1>
    STANDARD: typing.ClassVar[CANFormat]  # value = <CANFormat.STANDARD: 0>
    __members__: typing.ClassVar[dict[str, CANFormat]]  # value = {'STANDARD': <CANFormat.STANDARD: 0>, 'EXTENDED': <CANFormat.EXTENDED: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class CANFrame:
    ...
    def data(self) -> list[int]:
        ...
        """
    @data.setter
    def data(self, arg0: list[int]) -> None:
        ...
    @property
    def frame_format(self) -> int:
        ...
        """
    @frame_format.setter
    def frame_format(self, arg0: int) -> None:
        ...
    @property
    ...
    def frame_type(self) -> int:
        ...
        """
    @frame_type.setter
    def frame_type(self, arg0: int) -> None:
        ...
    @property
    def frame_valid_length(self) -> int:
        """
        有效数据长度
        """
    @frame_valid_length.setter
    def frame_valid_length(self, arg0: int) -> None:
        ...
class CANType:
    """
    CAN帧数据类型
    ...
    Members:
      ...
      CAN : 标准CAN
    """
    CAN: typing.ClassVar[CANType]  # value = <CANType.CAN: 2>
    CANFD: typing.ClassVar[CANType]  # value = <CANType.CANFD: 1>
    CANFD_ACCELERATED: typing.ClassVar[CANType]  # value = <CANType.CANFD_ACCELERATED: 0>
    __members__: typing.ClassVar[dict[str, CANType]]  # value = {'CANFD_ACCELERATED': <CANType.CANFD_ACCELERATED: 0>, 'CANFD': <CANType.CANFD: 1>, 'CAN': <CANType.CAN: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class Cobot_5(Robot_T_Collaborative_5, BaseCobot):
    ...
    def getRtMotionController(self) -> ...:
        ...
        """
    def jointPos(self, ec: dict) -> list:
        """
        机器人当前轴角度
...
class MoveAbsJCommand(NrtCommand):
    ...
    """
    @typing.overload
    def __init__(self, target: JointPosition, speed: float = -1, zone: float = -1) -> None:
        """
        构造函数
        ...
        """
    @typing.overload
    def __init__(self, target: list[float], speed: float = -1, zone: float = -1) -> None:
        """
        构造函数
...
class MoveCCommand(NrtCommand):
    ...
    运动指令 - 圆弧轨迹MoveC
    """
    def __init__(self, target: CartesianPosition, aux: CartesianPosition, speed: float = -1, zone: float = -1) -> None:
        """
        构造函数
...
class MoveCFCommand(NrtCommand):
    ...
    运动指令 - 全圆轨迹MoveCF
    """
    def __init__(self, target: CartesianPosition, aux: CartesianPosition, angle: float, speed: float = -1, zone: float = -1) -> None:
        """
        构造函数
...
class MoveJCommand(NrtCommand):
    ...
    """
    @typing.overload
    def __init__(self, target: CartesianPosition, speed: float = -1, zone: float = -1) -> None:
        """
        构造函数
        ...
        """
    @typing.overload
    def __init__(self, frame: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], speed: float = -1, zone: float = -1) -> None:
        ...
    @typing.overload
    def __init__(self, matrix: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)], speed: float = -1, zone: float = -1) -> None:
        ...
    @typing.overload
    def __init__(self, values: ..., speed: float = -1, zone: float = -1) -> None:
        ...
    @property
    def jointSpeed(self) -> float:
        """
...
class MoveSPCommand(NrtCommand):
    ...
    运动指令 - 螺旋线轨迹MoveSP
    """
    def __init__(self, target: CartesianPosition, r0: float, rStep: float, angle: float, dir: bool, speed: float = -1) -> None:
        """
        构造函数
...
class NrtCommand:
    ...
    def __init__(self) -> None:
        ...
        """
    @typing.overload
    def __init__(self, speed: float, zone: float) -> None:
        """
        构造函数
...
class PyForceControl5:
    ...
    def restartOverlay(self, ec: dict) -> None:
        ...
        Args:
            ec (dict): 错误码输出
        """
    def setCartesianControlMaxVel(self, max_cart_vel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setCartesianControlMaxWrench(self, max_wrench: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
    ...
    def setControlType(self, type: int, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFcGain(self, gain: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], ec: dict) -> None:
        """
    ...
    def setForceCondition(self, range: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], isInside: bool, timeout: float, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFriction(self, fric: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxTorque(self, max_torque: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], ec: dict) -> None:
        """
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxVel(self, max_joint_vel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(5)], ec: dict) -> None:
        """
...
class PyForceControl6:
    ...
    def setControlType(self, type: int, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFcGain(self, gain: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
        设置各轴力控带宽。fcStart()开始生效, fcStop后失效。
    ...
    def setForceCondition(self, range: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], isInside: bool, timeout: float, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFriction(self, fric: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
        设置各轴摩擦力补偿系数。fcStart()开始生效, fcStop后失效。
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxTorque(self, max_torque: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
        阻抗力限幅指令 - 关节。fcStart()开始生效, fcStop后失效。
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxVel(self, max_joint_vel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], ec: dict) -> None:
        """
        阻抗速度限幅 - 关节。fcStart()开始生效, fcStop后失效。
...
class PyForceControl7:
    ...
    def setControlType(self, type: int, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFcGain(self, gain: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], ec: dict) -> None:
        """
        设置各轴力控带宽。fcStart()开始生效, fcStop后失效。
    ...
    def setForceCondition(self, range: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)], isInside: bool, timeout: float, ec: dict) -> None:
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setFriction(self, fric: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], ec: dict) -> None:
        """
        设置各轴摩擦力补偿系数。fcStart()开始生效, fcStop后失效。
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxTorque(self, max_torque: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], ec: dict) -> None:
        """
        阻抗力限幅指令 - 关节。fcStart()开始生效, fcStop后失效。
        ...
        Args:
            ...
            ec (dict): 错误码输出
        """
    def setJointControlMaxVel(self, max_joint_vel: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(7)], ec: dict) -> None:
        """
        阻抗速度限幅 - 关节。fcStart()开始生效, fcStop后失效。
...
def message(arg0: dict) -> ...:
    ...
    打印错误码信息
    """
CAN: CANType  # value = <CANType.CAN: 2>
CANFD: CANType  # value = <CANType.CANFD: 1>
CANFD_ACCELERATED: CANType  # value = <CANType.CANFD_ACCELERATED: 0>
EXTENDED: CANFormat  # value = <CANFormat.EXTENDED: 1>
...
STANDARD: CANFormat  # value = <CANFormat.STANDARD: 0>
