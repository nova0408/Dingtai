...
class Config:
    ...
    def enable_stream(self, arg0: OBSensorType) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, stream_type: OBStreamType, width: int = 0, height: int = 0, fps: int = 0, format: OBFormat = ...) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, sensor_type: OBSensorType, width: int = 0, height: int = 0, fps: int = 0, format: OBFormat = ...) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, sensor_type: OBSensorType, decimation_config: OBHardwareDecimationConfig, fps: int = 0, format: OBFormat = ...) -> None:
        ...
...
class Context:
    ...
    def set_logger_level(arg0: OBLogLevel) -> None:
        ...
    @staticmethod
    def set_logger_to_callback(arg0: OBLogLevel, arg1: typing.Callable) -> None:
        """
    ...
    def __init__(self, arg0: str) -> None:
        ...
    def create_net_device(self, address: str, port: int, access_mode: OBDeviceAccessMode = ...) -> ...:
        """
        Create net device
        """
    ...
    def query_devices(self) -> ...:
        ...
        Query devices
        """
    def register_device_changed_callback(self, arg0: typing.Callable) -> int:
        ...
...
class Device:
    ...
    def trigger_capture(self) -> None:
        ...
    def update_firmware(self, file_path: str, callback: typing.Callable, async_update: bool = True) -> None:
        ...
    def update_optional_depth_presets(self, file_path_list: list, callback: typing.Callable) -> None:
        ...
class DeviceInfo:
    def __repr__(self) -> str:
        ...
...
class DeviceList:
    ...
    def get_count(self) -> int:
        ...
    def get_device_by_index(self, index: int, access_mode: OBDeviceAccessMode = ...) -> ...:
        ...
    def get_device_by_serial_number(self, serial_number: str, access_mode: OBDeviceAccessMode = ...) -> ...:
        ...
    def get_device_by_uid(self, uid: str, access_mode: OBDeviceAccessMode = ...) -> ...:
        ...
...
class Filter:
    ...
    def is_threshold_filter(self) -> bool:
        ...
    def process(self, arg0: ...) -> typing.Any:
        ...
...
class Frame:
    ...
    def as_ir_frame(self) -> ...:
        ...
    def as_lidar_points_frame(self) -> ...:
        ...
...
class OBDataTranState:
    ...
    __members__: typing.ClassVar[dict[str, OBDataTranState]]  # value = {'STOPPED': <OBDataTranState.STOPPED: 3>, 'DONE': <OBDataTranState.DONE: 2>, 'VERIFYING': <OBDataTranState.VERIFYING: 1>, 'TRANSFERRING': <OBDataTranState.TRANSFERRING: 0>, 'ERR_BUSY': <OBDataTranState.ERR_BUSY: -1>, 'ERR_UNSUPPORTED': <OBDataTranState.ERR_UNSUPPORTED: -2>, 'ERR_TRAN_FAILED': <OBDataTranState.ERR_TRAN_FAILED: -3>, 'ERR_VERIFY_FAILED': <OBDataTranState.ERR_VERIFY_FAILED: -4>, 'ERR_OTHER': <OBDataTranState.ERR_OTHER: -5>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBDepthWorkModeTag:
    ...
    """
    OB_CUSTOM_DEPTH_WORK_MODE: typing.ClassVar[OBDepthWorkModeTag]  # value = <OBDepthWorkModeTag.OB_CUSTOM_DEPTH_WORK_MODE: 1>
    OB_DEVICE_DEPTH_WORK_MODE: typing.ClassVar[OBDepthWorkModeTag]  # value = <OBDepthWorkModeTag.OB_DEVICE_DEPTH_WORK_MODE: 0>
    __members__: typing.ClassVar[dict[str, OBDepthWorkModeTag]]  # value = {'OB_DEVICE_DEPTH_WORK_MODE': <OBDepthWorkModeTag.OB_DEVICE_DEPTH_WORK_MODE: 0>, 'OB_CUSTOM_DEPTH_WORK_MODE': <OBDepthWorkModeTag.OB_CUSTOM_DEPTH_WORK_MODE: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBDeviceAccessMode:
    ...
    """
    OB_DEVICE_ACCESS_DENIED: typing.ClassVar[OBDeviceAccessMode]  # value = <OBDeviceAccessMode.OB_DEVICE_ACCESS_DENIED: 0>
    OB_DEVICE_CONTROL_ACCESS: typing.ClassVar[OBDeviceAccessMode]  # value = <OBDeviceAccessMode.OB_DEVICE_CONTROL_ACCESS: 2>
    OB_DEVICE_DEFAULT_ACCESS: typing.ClassVar[OBDeviceAccessMode]  # value = <OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS: 4>
    OB_DEVICE_EXCLUSIVE_ACCESS: typing.ClassVar[OBDeviceAccessMode]  # value = <OBDeviceAccessMode.OB_DEVICE_EXCLUSIVE_ACCESS: 1>
    OB_DEVICE_MONITOR_ACCESS: typing.ClassVar[OBDeviceAccessMode]  # value = <OBDeviceAccessMode.OB_DEVICE_MONITOR_ACCESS: 3>
    __members__: typing.ClassVar[dict[str, OBDeviceAccessMode]]  # value = {'OB_DEVICE_ACCESS_DENIED': <OBDeviceAccessMode.OB_DEVICE_ACCESS_DENIED: 0>, 'OB_DEVICE_EXCLUSIVE_ACCESS': <OBDeviceAccessMode.OB_DEVICE_EXCLUSIVE_ACCESS: 1>, 'OB_DEVICE_CONTROL_ACCESS': <OBDeviceAccessMode.OB_DEVICE_CONTROL_ACCESS: 2>, 'OB_DEVICE_MONITOR_ACCESS': <OBDeviceAccessMode.OB_DEVICE_MONITOR_ACCESS: 3>, 'OB_DEVICE_DEFAULT_ACCESS': <OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS: 4>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBFileTranState:
    ...
    __members__: typing.ClassVar[dict[str, OBFileTranState]]  # value = {'TRANSFER': <OBFileTranState.TRANSFER: 2>, 'DONE': <OBFileTranState.DONE: 1>, 'PREPARING': <OBFileTranState.PREPARING: 0>, 'ERR_DDR': <OBFileTranState.ERR_DDR: -1>, 'ERR_NOT_ENOUGH_SPACE': <OBFileTranState.ERR_NOT_ENOUGH_SPACE: -2>, 'ERR_PATH_NOT_WRITABLE': <OBFileTranState.ERR_PATH_NOT_WRITABLE: -3>, 'ERR_MD5_ERROR': <OBFileTranState.ERR_MD5_ERROR: -4>, 'ERR_WRITE_FLASH_ERROR': <OBFileTranState.ERR_WRITE_FLASH_ERROR: -5>, 'ERR_TIMEOUT': <OBFileTranState.ERR_TIMEOUT: -6>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBFilterConfigValueType:
    ...
    __members__: typing.ClassVar[dict[str, OBFilterConfigValueType]]  # value = {'INVALID': <OBFilterConfigValueType.INVALID: -1>, 'INT': <OBFilterConfigValueType.INT: 0>, 'FLOAT': <OBFilterConfigValueType.FLOAT: 1>, 'BOOLEAN': <OBFilterConfigValueType.BOOLEAN: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBFrameAggregateOutputMode:
    ...
    __members__: typing.ClassVar[dict[str, OBFrameAggregateOutputMode]]  # value = {'FULL_FRAME_REQUIRE': <OBFrameAggregateOutputMode.FULL_FRAME_REQUIRE: 0>, 'COLOR_FRAME_REQUIRE': <OBFrameAggregateOutputMode.COLOR_FRAME_REQUIRE: 1>, 'ANY_SITUATION': <OBFrameAggregateOutputMode.ANY_SITUATION: 2>, 'DISABLE': <OBFrameAggregateOutputMode.DISABLE: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBFrameMetadataType:
    ...
    DISPARITY_SEARCH_OFFSET: typing.ClassVar[OBFrameMetadataType]  # value = <OBFrameMetadataType.DISPARITY_SEARCH_OFFSET: 32>
    DISPARITY_SEARCH_RANGE: typing.ClassVar[OBFrameMetadataType]  # value = <OBFrameMetadataType.DISPARITY_SEARCH_RANGE: 33>
...
class OBGyroFullScaleRange:
    ...
    __members__: typing.ClassVar[dict[str, OBGyroFullScaleRange]]  # value = {'FS_16dps': <OBGyroFullScaleRange.FS_16dps: 1>, 'FS_31dps': <OBGyroFullScaleRange.FS_31dps: 2>, 'FS_62dps': <OBGyroFullScaleRange.FS_62dps: 3>, 'FS_125dps': <OBGyroFullScaleRange.FS_125dps: 4>, 'FS_250dps': <OBGyroFullScaleRange.FS_250dps: 5>, 'FS_500dps': <OBGyroFullScaleRange.FS_500dps: 6>, 'FS_1000dps': <OBGyroFullScaleRange.FS_1000dps: 7>, 'FS_2000dps': <OBGyroFullScaleRange.FS_2000dps: 8>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBMediaState:
    ...
    __members__: typing.ClassVar[dict[str, OBMediaState]]  # value = {'OB_MEDIA_BEGIN': <OBMediaState.OB_MEDIA_BEGIN: 0>, 'OB_MEDIA_PAUSE': <OBMediaState.OB_MEDIA_PAUSE: 1>, 'OB_MEDIA_RESUME': <OBMediaState.OB_MEDIA_RESUME: 2>, 'OB_MEDIA_END': <OBMediaState.OB_MEDIA_END: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBPixelType:
    ...
    __members__: typing.ClassVar[dict[str, OBPixelType]]  # value = {'OB_PIXEL_UNKNOWN': <OBPixelType.OB_PIXEL_UNKNOWN: -1>, 'OB_PIXEL_DEPTH': <OBPixelType.OB_PIXEL_DEPTH: 0>, 'OB_PIXEL_DISPARITY': <OBPixelType.OB_PIXEL_DISPARITY: 2>, 'OB_PIXEL_RAW_PHASE': <OBPixelType.OB_PIXEL_RAW_PHASE: 3>, 'OB_PIXEL_TOF_DEPTH': <OBPixelType.OB_PIXEL_TOF_DEPTH: 4>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBPlaybackStatus:
    ...
    __members__: typing.ClassVar[dict[str, OBPlaybackStatus]]  # value = {'UNKNOWN': <OBPlaybackStatus.UNKNOWN: 0>, 'PLAYING': <OBPlaybackStatus.PLAYING: 1>, 'PAUSED': <OBPlaybackStatus.PAUSED: 2>, 'STOPPED': <OBPlaybackStatus.STOPPED: 3>, 'COUNT': <OBPlaybackStatus.COUNT: 4>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class OBPropertyID:
    ...
    """
    OB_DEVICE_AUTO_CAPTURE_ENABLE_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_DEVICE_AUTO_CAPTURE_ENABLE_BOOL: 216>
    OB_DEVICE_AUTO_CAPTURE_INTERVAL_TIME_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_DEVICE_AUTO_CAPTURE_INTERVAL_TIME_INT: 217>
    OB_DEVICE_PTP_CLOCK_SYNC_ENABLE_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_DEVICE_PTP_CLOCK_SYNC_ENABLE_BOOL: 223>
    ...
    OB_PROP_CHECK_PPS_SYNC_IN_SIGNAL_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_CHECK_PPS_SYNC_IN_SIGNAL_BOOL: 195>
    OB_PROP_COLOR_AE_MAX_EXPOSURE_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_COLOR_AE_MAX_EXPOSURE_INT: 189>
    ...
    OB_PROP_DEBUG_ESGM_CONFIDENCE_FLOAT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DEBUG_ESGM_CONFIDENCE_FLOAT: 5013>
    ...
    OB_PROP_DEPTH_NOISE_REMOVAL_FILTER_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DEPTH_SOFT_FILTER_BOOL: 24>
    OB_PROP_DEPTH_NOISE_REMOVAL_FILTER_MAX_DIFF_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DEPTH_MAX_DIFF_INT: 40>
    OB_PROP_DEPTH_NOISE_REMOVAL_FILTER_MAX_SPECKLE_SIZE_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DEPTH_MAX_SPECKLE_SIZE_INT: 41>
    ...
    OB_PROP_DEVICE_REPOWER_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DEVICE_REPOWER_BOOL: 202>
    ...
    OB_PROP_DISP_SEARCH_OFFSET_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DISP_SEARCH_OFFSET_INT: 196>
    OB_PROP_DISP_SEARCH_RANGE_MODE_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_DISP_SEARCH_RANGE_MODE_INT: 191>
    ...
    OB_PROP_FRAME_INTERLEAVE_CONFIG_INDEX_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_FRAME_INTERLEAVE_CONFIG_INDEX_INT: 204>
    OB_PROP_FRAME_INTERLEAVE_ENABLE_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_FRAME_INTERLEAVE_ENABLE_BOOL: 205>
    OB_PROP_FRAME_INTERLEAVE_LASER_PATTERN_SYNC_DELAY_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_FRAME_INTERLEAVE_LASER_PATTERN_SYNC_DELAY_INT: 206>
    ...
    OB_PROP_HW_NOISE_REMOVE_FILTER_ENABLE_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_HW_NOISE_REMOVE_FILTER_ENABLE_BOOL: 211>
    OB_PROP_HW_NOISE_REMOVE_FILTER_THRESHOLD_FLOAT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_HW_NOISE_REMOVE_FILTER_THRESHOLD_FLOAT: 212>
    OB_PROP_INDICATOR_LIGHT_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_INDICATOR_LIGHT_BOOL: 83>
    OB_PROP_IR_AE_MAX_EXPOSURE_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_IR_AE_MAX_EXPOSURE_INT: 190>
    ...
    OB_PROP_LASER_HIGH_TEMPERATURE_PROTECT_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_LASER_HIGH_TEMPERATURE_PROTECT_BOOL: 193>
    ...
    OB_PROP_LIDAR_TAIL_FILTER_LEVEL_INT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_LIDAR_TAIL_FILTER_LEVEL_INT: 8006>
    OB_PROP_LOW_EXPOSURE_LASER_CONTROL_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_LOW_EXPOSURE_LASER_CONTROL_BOOL: 194>
    ...
    OB_PROP_ON_CHIP_CALIBRATION_ENABLE_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_ON_CHIP_CALIBRATION_ENABLE_BOOL: 210>
    OB_PROP_ON_CHIP_CALIBRATION_HEALTH_CHECK_FLOAT: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_ON_CHIP_CALIBRATION_HEALTH_CHECK_FLOAT: 209>
    ...
    OB_PROP_SLAVE_DEVICE_SYNC_STATUS_BOOL: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_PROP_SLAVE_DEVICE_SYNC_STATUS_BOOL: 188>
    ...
    OB_STRUCT_DISP_OFFSET_CONFIG: typing.ClassVar[OBPropertyID]  # value = <OBPropertyID.OB_STRUCT_DISP_OFFSET_CONFIG: 1064>
...
class PlaybackDevice(Device):
    ...
    def set_playback_rate(self, rate: float) -> None:
        ...
    def set_playback_status_change_callback(self, arg0: typing.Callable) -> None:
        ...
...
class StreamProfile:
    ...
    def as_gyro_stream_profile(self) -> ...:
        ...
    def as_lidar_stream_profile(self) -> ...:
        ...
...
class StreamProfileList:
    ...
    def get_stream_profile_by_index(self, arg0: int) -> StreamProfile:
        ...
    @typing.overload
    def get_video_stream_profile(self, width: int = 0, height: int = 0, format: OBFormat = ..., fps: int = 0) -> VideoStreamProfile:
        ...
    @typing.overload
    def get_video_stream_profile(self, decimation_config: OBHardwareDecimationConfig, format: OBFormat = ..., fps: int = 0) -> VideoStreamProfile:
        ...
...
def save_lidar_point_cloud_to_ply(arg0: str, arg1: LiDARPointsFrame, arg2: bool) -> None:
    ...
def save_point_cloud_to_ply(file_name: str, frame: Frame, save_binary: bool = False, use_mesh: bool = False, mesh_threshold: float = 50.0) -> None:
    ...
