...
DEFAULT_FAULT_LOG_PATH = PROJECT_ROOT / "logs" / "opening_detection_pipeline_fault.log"
DEFAULT_TIMING_CSV_PATH = PROJECT_ROOT / "logs" / "opening_detection_pipeline_timing.csv"
# endregion
...
def _worker_loop(
    ...
    pose_estimator = OpeningDetectionEstimator()
