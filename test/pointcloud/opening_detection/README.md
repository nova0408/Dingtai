...
本文档描述 `test_orbbec_realtime_estimate_opening_detection_pipeline.py` 的**当前实现**，重点说明：
...
- `test/pointcloud/opening_detection/test_orbbec_realtime_estimate_opening_detection_pipeline.py`
- `test/pointcloud/opening_detection/analyze_opening_detection_timing.py`
...
- `logs/opening_detection_pipeline_timing.csv`
...
```bash
python test/pointcloud/opening_detection/analyze_opening_detection_timing.py --show
```
