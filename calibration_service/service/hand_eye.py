...
def _to_transform(x: NDArray[np.float64]) -> NDArray[np.float64]:
...
def _solve_opencv_hand_eye(
    ...
    r_cam2gripper, t_cam2gripper = cv2.calibrateHandEye(  # pyright: ignore[reportAttributeAccessIssue]
        r_gripper2base,
        t_gripper2base,
        r_target2cam,
        t_target2cam,
